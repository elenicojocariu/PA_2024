...
*/
        ...
        Church church3 = new Church("Church3", "new");
        church3.addTimeInterval(DayOfWeek.TUESDAY, LocalTime.of(15, 30), LocalTime.of(18, 30));
        church3.addTimeInterval(DayOfWeek.FRIDAY, LocalTime.of(8, 30), LocalTime.of(15, 30));
        church3.addTimeInterval(DayOfWeek.THURSDAY, LocalTime.of(15, 0), LocalTime.of(18, 30));
        for (DayOfWeek dayOfWeek : DayOfWeek.values()) {
            if (dayOfWeek != DayOfWeek.TUESDAY && dayOfWeek != DayOfWeek.THURSDAY && dayOfWeek != DayOfWeek.FRIDAY) {
                church3.addTimeInterval(dayOfWeek, LocalTime.MIN, LocalTime.MIN);
            }
        }
        ...
        travelPlan.generateTravelPlan(startDate, endDate, trip.getAttractions());
